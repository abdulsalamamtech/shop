...
@section('content')
    ...
    <div class="ec-content-wrapper">
        ...
        <div class="content">
			...
			<div>
                    <h1>Orders</h1>
                    <p class="breadcrumbs"><span><a href="/admin.php">Home</a></span>
                    <span><i class="mdi mdi-chevron-right"></i></span>Order Invoice</p>
                </div>
                <div>
			...
			<div class="card invoice-wrapper border-radius border bg-white p-4">
				...
				<div class="row pt-5">
					...
					<div class="col-xl-2 col-lg-4 col-sm-6">
						...
						<address>
							...
							<br><span>Date :</span> 25 March, 2018
				...
				<div class="table-responsive">
					<table class="table mt-3 table-striped table-responsive table-responsive-large inv-tbl"
						...
						<tbody>
							<tr>
								<td>1</td>
								<td><img class="invoice-item-img" src=" {{ URL('assets/img/products/p1.jpg') }}" alt="product-image" /></td>
							...
							<tr>
								<td>2</td>
								<td><img class="invoice-item-img" src=" {{ URL('assets/img/products/p2.jpg') }}" alt="product-image"></td>
							...
							<tr>
								<td>3</td>
								<td><img class="invoice-item-img" src=" {{ URL('assets/img/products/p3.jpg') }}" alt="product-image"></td>
							...
							<tr>
								<td>4</td>
								<td><img class="invoice-item-img" src=" {{ URL('assets/img/products/p4.jpg') }}" alt="product-image"></td>
				...
				<div class="row justify-content-end inc-total">
					<div class="col-lg-3 col-xl-3 col-xl-3 ml-sm-auto">
						...
						<a href="javascript:void(0)" class="btn btn-block mt-2 btn-success btn-pill"> Payment Successful</a>
					</div>
				</div>
			</div>
