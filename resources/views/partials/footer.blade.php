    ...
    <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-secondary">
                2023 &copy; 
                <a class="text-primary" href="#">{{ config('app.name', 'Shop') }}</a>.
                All Rights Reserved. Dev.
                by
                <a class="text-primary" href="https://bit.ly/abdulsalamamtech">AmtechDigital</a>
                &
                <a class="text-primary" href="https://htmlcodex.com">HTMLCodex</a>
            </p>
        </div>
